...
用户输入 "review" 时，委托给 agent-skills:code-review-and-quality。
...
4. **Security**：输入验证？密钥安全？权限检查？（配合 agent-skills:security-and-hardening）
5. **Performance**：无 N+1 查询？无无界操作？（配合 agent-skills:performance-optimization）
