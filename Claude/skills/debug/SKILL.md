...
Capture the observed behavior and reproduction conditions. Form testable hypotheses, inspect evidence, isolate the root cause, and add a failing regression test under `work-products/tests/` when practical. Implement the smallest root-cause fix and run targeted plus relevant regression validation.
