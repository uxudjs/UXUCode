...
These are prevention patterns, not a ranking. For the 2021 ordering, see the [security checklist](../../references/security-checklist.md).
...
For detailed security checklists and pre-commit verification steps, see the [security checklist](../../references/security-checklist.md).
