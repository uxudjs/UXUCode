...
Create the `work-products/` directory if it does not exist. These paths are the convention expected by the `/uxu-code:build` command and other downstream tooling.
