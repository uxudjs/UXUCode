...
description: 以测试驱动开发。适用于实现任何逻辑、修复任何 bug、或改变任何行为时。适用于需要证明代码能正常工作时、收到 bug 报告时、或即将修改现有功能时。
---
...
For JavaScript/TypeScript testing patterns illustrating these principles — Jest, React Testing Library, Supertest, Playwright — see [testing patterns](../../references/testing-patterns.md). The principles transfer to any ecosystem; the syntax and tools there are JS/TS-specific.
