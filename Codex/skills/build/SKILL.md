...
Create product source and deliverables in their project-native locations. Create all process files only under `work-products/`, and all new test files under `work-products/tests/`.
